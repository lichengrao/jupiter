...
public class MySQLDBUtil {
    private static final String INSTANCE = "twitch-instance.ck5ryzo98icf.us-east-2.rds.amazonaws.com";
    ...
    public static String getMySQLAddress() throws IOException {
        ...
        return String.format("jdbc:mysql://%s:%s/%s?user=%s&password=%s&autoReconnect=true&serverTimezone=UTC" +
                "&createDatabaseIfNotExist=true", INSTANCE, PORT_NUM, DB_NAME, username, password);
    }
}
